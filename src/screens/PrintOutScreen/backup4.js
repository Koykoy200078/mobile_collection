...
// 			StatusBar.setBackgroundColor(isDarkMode ? 'black' : '#CCCCCC', true)
// 		}
...
// 						style={{ color: isDarkMode ? '#FFFFFF' : '#000' }}>
// 						{matchingItem.SLDESCR}
// 					</Text>
// 					<View style={{ flexDirection: 'row' }}>
// 						<View style={{ width: '50%' }}>
// 							<Text className='flex-shrink text-black dark:text-white font-semibold text-sm'>
// 								• Reference No.
// 							</Text>
// 						</View>
// 						<View>
...
// 				}
// 				onPressMain={checkPrinterStatus}
// 			/>
// 		</SafeAreaView>
// 	)
// }
